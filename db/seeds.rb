...
# luc = Talent.create!(city: "Paris", email: "dimitri@ineva-partners.com", password: "password", firstname: "luc", last_name: "buisson", phone:"0786019941", linkedin:"https://www.linkedin.com/feed/?trk=hb_signin", btoc: false, btob:true, validated: false, visible:false ,overview:"Ausus negotiis defensantem iam eos praeerat eos adoritur in praeerat iustissimus rector rector et abrupto Paulum minui rector exitio adhuc instabat defensantem potuit sortem mucronem inpegit ut imperatoris casus levare cognomentum sortem ille vicarium Paulus iam conplicandis dextera praeerat eos eundem ausus conplicandis negotiis abrupto mucronem dextera miserabiles cum minui.", terms_of_condition: true)
# p "#{luc}"
# donatien = Talent.create!(city: "Paris", email: "donatien@rollandmail.com", password: "password", firstname: "donatien", last_name: "rolland", phone:"0786019941", linkedin:"https://www.linkedin.com/feed/?trk=hb_signin", btoc: true, btob:true, validated: false, visible:false ,overview:"Ausus negotiis defensantem iam eos praeerat eos adoritur in praeerat iustissimus rector rector et abrupto Paulum minui rector exitio adhuc instabat defensantem potuit sortem mucronem inpegit ut imperatoris casus levare cognomentum sortem ille vicarium Paulus iam conplicandis dextera praeerat eos eundem ausus conplicandis negotiis abrupto mucronem dextera miserabiles cum minui.", terms_of_condition: true)
# dorian = Talent.create!(city: "Paris", email: "dorian.gentine@mail.novancia.fr", password: "password", firstname: "dorian", last_name: "gentine", phone:"0786019941", linkedin:"https://www.linkedin.com/feed/?trk=hb_signin", btoc: true, btob:false, validated: true, visible:true ,overview:"Ausus negotiis defensantem iam eos praeerat eos adoritur in praeerat iustissimus rector rector et abrupto Paulum minui rector exitio adhuc instabat defensantem potuit sortem mucronem inpegit ut imperatoris casus levare cognomentum sortem ille vicarium Paulus iam conplicandis dextera praeerat eos eundem ausus conplicandis negotiis abrupto mucronem dextera miserabiles cum minui.", terms_of_condition: true)
# erwan = Talent.create!(city: "Paris", email: "erwan@avemcreation.com", password: "password", firstname: "erwan", last_name: "guillou", phone:"0786019941", linkedin:"https://www.linkedin.com/feed/?trk=hb_signin", btoc: true, btob:true, validated: true, visible:true ,overview:"Ausus negotiis defensantem iam eos praeerat eos adoritur in praeerat iustissimus rector rector et abrupto Paulum minui rector exitio adhuc instabat defensantem potuit sortem mucronem inpegit ut imperatoris casus levare cognomentum sortem ille vicarium Paulus iam conplicandis dextera praeerat eos eundem ausus conplicandis negotiis abrupto mucronem dextera miserabiles cum minui.", terms_of_condition: true)
# louis = Talent.create!(city: "Paris", email: "magdalena@ineva-partners.com", password: "password", firstname: "fanny", last_name: "dupont", phone:"0786013426", linkedin:"https://www.linkedin.com/feed/?trk=hb_signin", btoc: true, btob:false, validated: true, visible:true ,overview:"Ausus negotiis defensantem iam eos praeerat eos adoritur in praeerat iustissimus rector rector et abrupto Paulum minui rector exitio adhuc instabat defensantem potuit sortem mucronem inpegit ut imperatoris casus levare cognomentum sortem ille vicarium Paulus iam conplicandis dextera praeerat eos eundem ausus conplicandis negotiis abrupto mucronem dextera miserabiles cum minui.", terms_of_condition: true)
