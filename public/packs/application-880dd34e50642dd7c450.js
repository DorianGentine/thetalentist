...
if (filterMetiers) {
	...
	(function () {
		...
		var showCards = function showCards() {
			...
			searchResults.innerHTML = "<strong>" + nbActifs + " profils</strong> correspondent à votre recherche '" + filtreActifs.join(" ,") + "'";
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-880dd34e50642dd7c450.js.map