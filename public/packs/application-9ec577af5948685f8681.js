...
if (filterMetiers) {
	...
	(function () {
		...
		var showCards = function showCards() {
			...
			var filtreCapitalized = filtreActifs.map(function (a) {
				return a.charAt(0).toUpperCase() + a.slice(1);
			});
			searchResults.innerHTML = "<strong>" + nbActifs + " profils</strong> correspondent à votre recherche '" + filtreCapitalized.join(" ,") + "'";
			console.log(filtreCapitalized);
		};
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-9ec577af5948685f8681.js.map