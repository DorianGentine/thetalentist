...
if (filterMetiers) {
	...
	(function () {
		...
		var showCards = function showCards() {
			...
			searchResults.innerHTML = "<strong>" + nbActifs + " profils</strong> correspondent à votre recherche '" + filtreActifs.capitalize().join(" ,") + "'";
			console.log("nbActifs", nbActifs);
		};
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-802a30956b15787d578b.js.map