...
if (filterMetiers) {
	...
	(function () {
		...
		var showCards = function showCards() {
			...
			searchResults.innerHTML = "<strong>" + nbActifs + " profils</strong> correspondent à votre recherche '<em><%= params[:tag] || 'Tous' %></em>";
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-5c796e4aac855dd4a50c.js.map