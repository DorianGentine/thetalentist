    ...
    @talents.each do |talent|
      ...
      talent_injected = {
        ...
        next_aventure: {
          ...
          dream: talent.next_aventures.count > 0 && talent.next_aventures.first.dream.present? ? talent.next_aventures.first.dream : false,
          good_manager: talent.next_aventures.count > 0 && talent.next_aventures.first.good_manager.present? ? talent.next_aventures.first.good_manager : false,
          proud: talent.next_aventures.count > 0 && talent.next_aventures.first.proud.present? ? talent.next_aventures.first.proud : false,
